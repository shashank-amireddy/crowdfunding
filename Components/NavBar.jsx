            ...
            <div className="relative flex items-center justify-between">
              <div className="flex items-center">
                <a href="/" aria-label="Company" title="Company" className="inline-flex items-center mr-8">
                  ...
                  <span className="ml-2 text-xl font-bold tracking-wide text-gray-100 uppercase">Crowd Funding</span>
                </a>
                    ...
                    <div className="absolute top-0 left-0 w-full">
                        ...
                        <div className="flex items-center justify-between mb-4">
                          <div>
                            <a href="/" aria-label="Company" title="Company" className="inline-flex items-center">
                              ...
                              <span className="ml-2 text-xl font-bold tracking-wide text-gray-800 uppercase">Crowd Funding</span>
                            </a>
                          </div>
                          <div>
                      ...
                      <nav>
                        <ul className="space-y-4">
                          ...
                          <li>
                            <a href="#" className="inline-flex items-center background justify-center w-full h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-deep-purple-accent-400 hover:bg-deep-purple-accent-700 focus:shadow-outline focus:outline-none" aria-label="Sign up" title="Sign up">
                              Connect Wallet
                            </a>
                          </li>
                        </ul>
